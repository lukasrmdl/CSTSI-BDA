...
try {
    ...
    await client.db('banco-bda').collection('produtos').createIndex({ descricao: 'text' });
    ...
    const opcoes = {//options
        projection: {_id: 0, qtd_estoque: 0, id_prod: 0, nome: 0, preco: 0, importado: 0, desconto: 0} //projeção
    }
